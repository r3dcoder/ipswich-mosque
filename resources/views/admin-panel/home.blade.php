        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <div class="space-y-4">
                ...
                <a href="{{ route('admin.quick-links.index') }}" 
                   class="group block p-6 border border-gray-200 rounded-lg hover:border-cyan-300 hover:bg-cyan-50 transition-all duration-200">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 group-hover:text-cyan-700">Quick Links</h4>
                            <p class="text-sm text-gray-600 mt-1">Manage homepage quick access tiles</p>
                        </div>
                        <div class="ml-auto text-cyan-600">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </div>

...
@section('title', 'Edit Khutbah')
@section('header', 'Edit Khutbah')
...
<div class="max-w-4xl">
    ...
    <form action="{{ route('admin.khutbahs.update', $khutbah) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white border rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="url" name="youtube_url" value="{{ old('youtube_url', $khutbah->youtube_url) }}" required
                           class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900"
                ...
                <div>
                    ...
                    <input type="text" name="speaker" value="{{ old('speaker', $khutbah->speaker) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900"
                ...
                <div>
                    ...
                    <select name="category" required class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900">
                        @foreach($categories as $key => $label)
                            <option value="{{ $key }}" {{ old('category', $khutbah->category) === $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="delivered_date" value="{{ old('delivered_date', $khutbah->delivered_date?->format('Y-m-d')) }}"
                           class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Duration (minutes)</label>
                    <input type="number" name="duration" value="{{ old('duration', $khutbah->duration) }}" min="1" max="300"
                           class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900"
                           placeholder="e.g., 30">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="4"
                              class="w-full rounded-lg border-gray-300 focus:border-gray-900 focus:ring-gray-900"
                              placeholder="Brief description of the khutbah...">{{ old('description', $khutbah->description) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white border rounded-xl p-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center">
                    <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $khutbah->is_featured) ? 'checked' : '' }}
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $khutbah->is_active) ? 'checked' : '' }}
                           class="rounded border-gray-300 text-gray-900 focus:ring-gray-900">
                ...
                <div class="flex items-center">
                    <input type="number" name="sort_order" value="{{ old('sort_order', $khutbah->sort_order) }}" min="0"

...
<div class="max-w-4xl mx-auto">
    ...
    <form method="POST" action="{{ route('admin.notices.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="summary" name="summary" rows="2" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                        placeholder="Brief summary of the notice...">{{ old('summary') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="content" name="content" rows="10" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                        placeholder="Full notice content...">{{ old('content') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-4">
            ...
            <button type="submit" class="px-6 py-3 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition">Create Notice</button>
        </div>
    </form>
</div>
@endsection
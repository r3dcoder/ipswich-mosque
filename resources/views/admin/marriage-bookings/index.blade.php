...
@section('title', 'Marriage Bookings')
@section('header', 'Marriage Bookings')

@section('content')
<div>
    <div class="flex items-center justify-between mb-6 flex-wrap gap-4">
        <div>
            <h2 class="text-lg font-semibold">Marriage/Nikah Bookings</h2>
            <p class="text-sm text-gray-600">Manage venue bookings for marriage ceremonies</p>
        </div>
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.marriage-bookings.index', ['status' => 'pending']) }}" 
            ...
            <a href="{{ route('admin.marriage-bookings.index', ['status' => 'confirmed']) }}" 
            ...
            <table class="min-w-full text-sm">
                <thead class="bg-gray-50 border-b">
                    <tr>
                        ...
                        <th class="text-left px-4 py-3">Proposed Date</th>
                ...
                @forelse($bookings as $booking)
                    <tr class="{{ $booking->read ? '' : 'bg-blue-50' }}">
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $booking->proposed_date ?? '-' }}</td>
                        <td class="px-4 py-3 text-gray-600">{{ $booking->expected_guests ?? '-' }}</td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3 text-right space-x-2 whitespace-nowrap">
                            ...
                            @if(!$booking->read)
                                <form action="{{ route('admin.marriage-bookings.mark-as-read', $booking) }}" method="POST" class="inline">
                                    @csrf

                ...
                @forelse($sections as $s)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-2 whitespace-nowrap">
                            ...
                            <form method="POST"
                                  action="{{ route('admin.courses.destroy', $s) }}"
                                  class="inline"
                                  onsubmit="return confirm('Delete this section? It will delete ALL courses, features, and images.')">
                                @csrf
                                @method('DELETE')
                                <button class="inline-flex px-3 py-1.5 rounded-lg border border-red-200 text-red-700 text-sm hover:bg-red-50">
                                    Delete
                                </button>
                            </form>
                        </td>
